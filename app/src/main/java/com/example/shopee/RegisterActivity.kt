...
class RegisterActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val txtconpassword = findViewById<EditText>(R.id.txtconpassword)
        ...
        btnregister.setOnClickListener {
            ...
            if (conpassword.isEmpty()) {
                txtconpassword.error = "Please enter your confirm password"
            }
            if (password != conpassword) {
                txtconpassword.error = "Password does not match"
                return@setOnClickListener
            }
            val url = "http://10.10.9.112:3000/register"
